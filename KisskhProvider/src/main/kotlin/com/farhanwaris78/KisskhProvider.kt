...
class KisskhProvider : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        "&type=2&sub=0&country=0&status=0&order=1" to "Movie Popular",
        "&type=2&sub=0&country=0&status=0&order=2" to "Movie Last Update",
        "&type=2&sub=0&country=0&status=0&order=3" to "Movie Release Date",
        "&type=1&sub=0&country=0&status=0&order=1" to "TVSeries Popular",
        "&type=1&sub=0&country=0&status=0&order=2" to "TVSeries Last Update",
        "&type=1&sub=0&country=0&status=0&order=3" to "TVSeries Release Date",
        "&type=3&sub=0&country=0&status=0&order=1" to "Anime Popular",
        "&type=3&sub=0&country=0&status=0&order=2" to "Anime Last Update",
        "&type=3&sub=0&country=0&status=0&order=3" to "Anime Release Date",
        ...
        "&type=4&sub=0&country=0&status=0&order=3" to "Hollywood Release Date",
        "&type=1&sub=0&country=2&status=0&order=1" to "TVs South Korea Popular",
        "&type=1&sub=0&country=2&status=0&order=2" to "TVs South Korea Last Update",
        "&type=1&sub=0&country=2&status=0&order=3" to "TVs South Korea RD",
        "&type=1&sub=0&country=1&status=0&order=1" to "TVs China Popular",
        "&type=1&sub=0&country=1&status=0&order=2" to "TVs China LU",
        "&type=1&sub=0&country=1&status=0&order=3" to "TVs China RD",
        "&type=1&sub=0&country=5&status=0&order=1" to "TVs Thailand Popular",
        "&type=1&sub=0&country=5&status=0&order=2" to "TVs Thailand LU",
        "&type=1&sub=0&country=5&status=0&order=3" to "TVs Thailand RD",
        "&type=1&sub=0&country=3&status=0&order=1" to "TVs Japan Popular",
        "&type=1&sub=0&country=3&status=0&order=2" to "TVs Japan LU",
        "&type=1&sub=0&country=3&status=0&order=3" to "TVs Japan RD",
        "&type=1&sub=0&country=7&status=0&order=1" to "TVs Taiwan Popular",
        "&type=1&sub=0&country=7&status=0&order=2" to "TVs Taiwan LU",
        "&type=1&sub=0&country=7&status=0&order=3" to "TVs Taiwan RD",
    )
